...
- [実験案](#実験案)
  ...
  - [その4](#その4)
  - [その5](#その5)
- [\\end{bmatrix} \\newline](#endbmatrix-newline)
- [\\end{bmatrix} \\newline](#endbmatrix-newline-1)
- [論文](#論文)
...
-ie^{i \beta}\sin{2 \theta _ Q}\cos{2 \theta _ H}+(1+i\cos{2 \theta _ Q})\sin{2 \theta _ H}
\end{bmatrix}
\end{aligned}
$$
...
１，垂直、水平、斜め　それぞれの偏光は直線偏光子をかませればいい
...
つまりQWPで変換される前のビームの水平偏光成分が、最終的に得られるベクトルビームの左回り円偏光成分に、垂直成分が右回り円偏光成分に対応している
...
### "Generation of fractional and ultra-high polarization-order vector vortex"
