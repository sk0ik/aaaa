...
## その5
![Alt text](<shapes at 24-01-14 18.20.20.png>)
...
&=
\begin{bmatrix}
1-\cos{2\theta _ Q} & -i\sin{\theta _ Q} \newline
-i\sin{\theta _ Q} & 1+\cos{2\theta _ Q}
\end{bmatrix}
\begin{bmatrix}
...
\end{bmatrix}
\begin{bmatrix}
e^{i\beta}\cos^2{2\theta _ H}-\sin^2{2\theta _ H} \newline
-e^{i\beta}\sin{2\theta _ H}\cos{2\theta _ H}-\sin{2\theta _ H}\cos{2\theta _ H}
\end{bmatrix} \newline
&=
...
\end{bmatrix}
\begin{bmatrix}
e^{i\frac{\beta}{2}}\cos^2{2\theta _ H}-e^{-i\frac{\beta}{2}}\sin^2{2\theta _ H} \newline
-\frac{\sin{4\theta _ H}}{2}(e^{i\frac{\beta}{2}}+e^{-i\frac{\beta}{2}})
\end{bmatrix} \newline
&=
e^{i\alpha}e^{i\frac{\beta}{2}}
\begin{bmatrix}
...
\end{bmatrix}
\begin{bmatrix}
\cos{\frac{\beta}{2}}\cos{4\theta _ H}+i\sin{\frac{\beta}{2}} \newline
-\cos{\frac{\beta}{2}}\sin{4\theta _ H}
\end{bmatrix} \newline
\therefore \boldsymbol{E}
&=
e^{i\alpha}e^{i\frac{\beta}{2}}
\begin{bmatrix}
(1-\cos{2\theta _ Q})(\cos{\frac{\beta}{2}}\cos{4\theta _ H}+i\sin{\frac{\beta}{2}})+i\cos{\frac{\beta}{2}}\sin{\theta _ Q}\sin{4\theta _ H} \newline
-i\sin{\theta _ Q}(\cos{\frac{\beta}{2}}\cos{4\theta _ H}+i\sin{\frac{\beta}{2}})-\cos{\frac{\beta}{2}}\sin{4\theta _ H}(1+\cos{2\theta _ Q})
\end{bmatrix} \newline
\end{aligned}
$$
