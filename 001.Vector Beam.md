...
e^{i \alpha}
\begin{bmatrix}
e^{i \beta} \left(1- \cos{2 \theta _ Q} \right) \ \cos{2 \theta _ H}.-i \sin{2 \theta _ Q} \sin{2 \theta _ H} \newline
.-ie^{i \beta} \sin{2 \theta _ Q} \cos{2 \theta _ H}+\left(1+ \cos{2 \theta _ Q} \right) \sin{2 \theta _ H}
\end{bmatrix}
\end{aligned}
$$
